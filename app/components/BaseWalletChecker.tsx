        ...
        <Modal title="Documentation" icon={Book}>
          <div className="space-y-4">
            ...
            <ol className="list-decimal list-inside space-y-2 text-gray-600">
              <li>Connect your wallet using MetaMask or Base Account</li>
      ...
      {activeModal === 'privacy' && (
        <Modal title="Privacy Policy" icon={Shield}>
          <div className="space-y-4 text-gray-600">
            ...
            <p>LedgerView is a client-side application that does not collect, store, or transmit personal data. All interactions occur directly between your browser and the Base blockchain. We never have access to your private keys or seed phrases.</p>
          </div>
        </Modal>
      )}
      {activeModal === 'terms' && (
        <Modal title="Terms of Service" icon={FileText}>
          <div className="space-y-4 text-gray-600">
            <p className="text-sm text-gray-500">Last updated: June 2026</p>
            <p>LedgerView is provided &quot;as is&quot; without warranty. We do not guarantee accuracy of blockchain data. Use at your own risk. For questions: andromedacripto17@gmail.com</p>
          </div>
        </Modal>
      )}
      {activeModal === 'contact' && (
              ...
              <div className="text-center md:text-right">
                ...
                <div className="flex flex-col items-center md:items-end gap-4">
                  <div className="flex items-center gap-4">
                    <a href="#" className="bg-white/10 hover:bg-white/20 p-2 rounded-lg transition-all hover:scale-110"><Globe className="w-5 h-5 text-white" /></a>
                    <a href="https://github.com/andromedacripto/LedgerView" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-white/20 p-2 rounded-lg transition-all hover:scale-110"><GitBranch className="w-5 h-5 text-white" /></a>
                    <a href="#" className="bg-white/10 hover:bg-white/20 p-2 rounded-lg transition-all hover:scale-110"><Globe className="w-5 h-5 text-white" /></a>
                  </div>
                  <button onClick={() => setActiveModal('contact')} className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-4 py-2 rounded-lg text-sm font-semibold flex items-center gap-2 hover:scale-105 transition-all">
