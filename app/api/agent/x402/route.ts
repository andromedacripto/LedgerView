...
const PAY_TO_ADDRESS = '0xdBDE47B99CcCd97cdb8BA5f6049b04e766659B53' as const
...
`
    ...
    const completion = await groq.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: `You are LedgerView Agent (x402 paid tier), an AI blockchain analytics assistant for the Base network (Base Mainnet, chainId 8453).
...
${walletContext}`,
    ...
    console.error('[agent/x402] error:', err)
...
export const POST = withX402(
  handler,
  {
    ...
    description: 'LedgerView Agent — Base Mainnet wallet analysis (paid x402 tier)',
  },
  resourceServer
)
