...
var MessageType = /* @__PURE__ */ ((MessageType2) => {
  ...
  MessageType2[MessageType2["LEND_STORAGE"] = 15] = "LEND_STORAGE";
  return MessageType2;
})(MessageType || {});
...
var UserDataType = /* @__PURE__ */ ((UserDataType3) => {
  ...
  UserDataType3[UserDataType3["PROFILE_TOKEN"] = 13] = "PROFILE_TOKEN";
...
var StorageUnitType = /* @__PURE__ */ ((StorageUnitType3) => {
  StorageUnitType3[StorageUnitType3["UNIT_TYPE_LEGACY"] = 0] = "UNIT_TYPE_LEGACY";
  StorageUnitType3[StorageUnitType3["UNIT_TYPE_2024"] = 1] = "UNIT_TYPE_2024";
  StorageUnitType3[StorageUnitType3["UNIT_TYPE_2025"] = 2] = "UNIT_TYPE_2025";
...
function storageUnitTypeFromJSON(object) {
  switch (object) {
    ...
    default:
      throw new tsProtoGlobalThis2.Error("Unrecognized enum value " + object + " for enum StorageUnitType");
  }
}
...
var MessageData = {
  encode(message, writer = import_minimal2.default.Writer.create()) {
    ...
    if (message.lendStorageBody !== void 0) {
  ...
  fromJSON(object) {
    return {
      ...
      lendStorageBody: isSet2(object.lendStorageBody) ? LendStorageBody.fromJSON(object.lendStorageBody) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
    ...
    message.lendStorageBody !== void 0 && (obj.lendStorageBody = message.lendStorageBody ? LendStorageBody.toJSON(message.lendStorageBody) : void 0);
    return obj;
  },
  create(base) {
  ...
  fromPartial(object) {
    ...
    message.lendStorageBody = object.lendStorageBody !== void 0 && object.lendStorageBody !== null ? LendStorageBody.fromPartial(object.lendStorageBody) : void 0;
    return message;
  }
};
...
function createBaseLendStorageBody() {
...
var LendStorageBody = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.toFid = longToNumber2(reader.uint64());
          continue;
        case 2:
          if (tag != 16) {
            break;
          }
          message.numUnits = longToNumber2(reader.uint64());
          continue;
        case 3:
          if (tag != 24) {
            break;
  ...
  fromJSON(object) {
    return {
      toFid: isSet2(object.toFid) ? Number(object.toFid) : 0,
      numUnits: isSet2(object.numUnits) ? Number(object.numUnits) : 0,
      unitType: isSet2(object.unitType) ? storageUnitTypeFromJSON(object.unitType) : 0
    };
  },
  toJSON(message) {
    const obj = {};
    message.toFid !== void 0 && (obj.toFid = Math.round(message.toFid));
    message.numUnits !== void 0 && (obj.numUnits = Math.round(message.numUnits));
    message.unitType !== void 0 && (obj.unitType = storageUnitTypeToJSON(message.unitType));
    return obj;
  },
  create(base) {
    return LendStorageBody.fromPartial(base != null ? base : {});
  },
  fromPartial(object) {
    var _a, _b, _c;
    const message = createBaseLendStorageBody();
    message.toFid = (_a = object.toFid) != null ? _a : 0;
    message.numUnits = (_b = object.numUnits) != null ? _b : 0;
    message.unitType = (_c = object.unitType) != null ? _c : 0;
    return message;
  }
};
...
var BlockConfirmedBody = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.totalEvents = longToNumber4(reader.uint64());
          continue;
        case 6:
          if (tag != 50) {
            break;
        ...
        case 7:
          ...
          message.maxBlockEventSeqnum = longToNumber4(reader.uint64());
          continue;
      }
      if ((tag & 7) == 4 || tag == 0) {
        break;
  ...
  fromJSON(object) {
    return {
      ...
      totalEvents: isSet4(object.totalEvents) ? Number(object.totalEvents) : 0,
      eventCountsByType: isObject(object.eventCountsByType) ? Object.entries(object.eventCountsByType).reduce((acc, [key, value]) => {
        acc[Number(key)] = Number(value);
        return acc;
      }, {}) : {},
      maxBlockEventSeqnum: isSet4(object.maxBlockEventSeqnum) ? Number(object.maxBlockEventSeqnum) : 0
    };
  },
  toJSON(message) {
    const obj = {};
    ...
    message.maxBlockEventSeqnum !== void 0 && (obj.maxBlockEventSeqnum = Math.round(message.maxBlockEventSeqnum));
    return obj;
  },
  create(base) {
  ...
  fromPartial(object) {
    ...
    message.maxBlockEventSeqnum = (_g = object.maxBlockEventSeqnum) != null ? _g : 0;
    return message;
  }
};
...
var BlockConfirmedBody_EventCountsByTypeEntry = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.value = longToNumber4(reader.uint64());
          continue;
      }
      if ((tag & 7) == 4 || tag == 0) {
        break;
  ...
  fromJSON(object) {
    return { key: isSet4(object.key) ? Number(object.key) : 0, value: isSet4(object.value) ? Number(object.value) : 0 };
  },
  toJSON(message) {
    const obj = {};
...
var HubEvent = {
  ...
  fromJSON(object) {
    return {
      ...
      blockConfirmedBody: isSet4(object.blockConfirmedBody) ? BlockConfirmedBody.fromJSON(object.blockConfirmedBody) : void 0,
      blockNumber: isSet4(object.blockNumber) ? Number(object.blockNumber) : 0,
      shardIndex: isSet4(object.shardIndex) ? Number(object.shardIndex) : 0,
      timestamp: isSet4(object.timestamp) ? Number(object.timestamp) : 0
    };
...
var ValidateOrRevokeJobState = {
  ...
  fromJSON(object) {
    return {
      lastJobTimestamp: isSet5(object.lastJobTimestamp) ? Number(object.lastJobTimestamp) : 0,
      lastFid: isSet5(object.lastFid) ? Number(object.lastFid) : 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var HubState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 2:
          ...
          message.lastFnameProof = longToNumber5(reader.uint64());
          continue;
        case 3:
          if (tag != 24) {
            break;
          }
          message.lastL2Block = longToNumber5(reader.uint64());
          continue;
        case 5:
          if (tag != 42) {
            break;
  ...
  fromJSON(object) {
    return {
      lastFnameProof: isSet5(object.lastFnameProof) ? Number(object.lastFnameProof) : 0,
      lastL2Block: isSet5(object.lastL2Block) ? Number(object.lastL2Block) : 0,
      validateOrRevokeState: isSet5(object.validateOrRevokeState) ? ValidateOrRevokeJobState.fromJSON(object.validateOrRevokeState) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
  ...
  toJSON(message) {
    ...
    if (message.childHashes) {
      Object.entries(message.childHashes).forEach(([k, v]) => {
        obj.childHashes[k] = base64FromBytes5(v);
      });
    }
    return obj;
  },
...
var DbTrieNode_ChildHashesEntry = {
  ...
  fromJSON(object) {
    return {
      key: isSet6(object.key) ? Number(object.key) : 0,
      value: isSet6(object.value) ? bytesFromBase645(object.value) : new Uint8Array()
    };
  },
  toJSON(message) {
    const obj = {};
...
function createBaseDbMerkleTrieMetadata() {
  return { outdatedHash: false };
}
var DbMerkleTrieMetadata = {
  encode(message, writer = import_minimal6.default.Writer.create()) {
  ...
  fromJSON(object) {
    return { outdatedHash: isSet6(object.outdatedHash) ? Boolean(object.outdatedHash) : false };
  },
  toJSON(message) {
    const obj = {};
    message.outdatedHash !== void 0 && (obj.outdatedHash = message.outdatedHash);
    return obj;
  },
  create(base) {
    return DbMerkleTrieMetadata.fromPartial(base != null ? base : {});
  },
  fromPartial(object) {
    var _a;
    const message = createBaseDbMerkleTrieMetadata();
    message.outdatedHash = (_a = object.outdatedHash) != null ? _a : false;
    return message;
  }
};
...
function blockEventTypeFromJSON(object) {
  switch (object) {
    case 0:
    ...
    case "BLOCK_EVENT_TYPE_MERGE_MESSAGE":
      return 1 /* MERGE_MESSAGE */;
    default:
      throw new tsProtoGlobalThis7.Error("Unrecognized enum value " + object + " for enum BlockEventType");
  }
}
function blockEventTypeToJSON(object) {
  switch (object) {
    case 0 /* HEARTBEAT */:
...
var Height = {
  ...
  fromJSON(object) {
    return {
      ...
      blockNumber: isSet7(object.blockNumber) ? Number(object.blockNumber) : 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var ShardHash = {
  ...
  fromJSON(object) {
    return {
      shardIndex: isSet7(object.shardIndex) ? Number(object.shardIndex) : 0,
      hash: isSet7(object.hash) ? bytesFromBase646(object.hash) : new Uint8Array()
    };
  },
  toJSON(message) {
    const obj = {};
...
var CommitSignature = {
  ...
  fromJSON(object) {
    return {
      ...
      signature: isSet7(object.signature) ? bytesFromBase646(object.signature) : new Uint8Array()
    };
  },
  toJSON(message) {
    const obj = {};
    message.signer !== void 0 && (obj.signer = base64FromBytes6(message.signer !== void 0 ? message.signer : new Uint8Array()));
    message.signature !== void 0 && (obj.signature = base64FromBytes6(message.signature !== void 0 ? message.signature : new Uint8Array()));
    return obj;
  },
  create(base) {
...
var Commits = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.round = longToNumber6(reader.int64());
          continue;
        case 3:
          if (tag != 26) {
            break;
  ...
  fromJSON(object) {
    return {
      height: isSet7(object.height) ? Height.fromJSON(object.height) : void 0,
      round: isSet7(object.round) ? Number(object.round) : 0,
      value: isSet7(object.value) ? ShardHash.fromJSON(object.value) : void 0,
...
function createBaseHeartbeatEventBody() {
  return {};
}
var HeartbeatEventBody = {
  ...
  create(base) {
    return HeartbeatEventBody.fromPartial(base != null ? base : {});
  },
  fromPartial(_) {
    const message = createBaseHeartbeatEventBody();
    return message;
...
function createBaseMergeMessageEventBody() {
  return { message: void 0 };
}
var MergeMessageEventBody = {
  encode(message, writer = import_minimal7.default.Writer.create()) {
    if (message.message !== void 0) {
      Message.encode(message.message, writer.uint32(10).fork()).ldelim();
    }
  ...
  fromJSON(object) {
    return { message: isSet7(object.message) ? Message.fromJSON(object.message) : void 0 };
  },
  toJSON(message) {
    const obj = {};
    message.message !== void 0 && (obj.message = message.message ? Message.toJSON(message.message) : void 0);
  ...
  create(base) {
    return MergeMessageEventBody.fromPartial(base != null ? base : {});
  },
  fromPartial(object) {
    const message = createBaseMergeMessageEventBody();
    message.message = object.message !== void 0 && object.message !== null ? Message.fromPartial(object.message) : void 0;
...
function createBaseBlockEventData() {
  return {
    seqnum: 0,
    type: 0,
    blockNumber: 0,
    eventIndex: 0,
    blockTimestamp: 0,
    heartbeatEventBody: void 0,
    mergeMessageEventBody: void 0
  };
}
var BlockEventData = {
  encode(message, writer = import_minimal7.default.Writer.create()) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.seqnum = longToNumber6(reader.uint64());
          continue;
        case 2:
          if (tag != 16) {
            break;
        ...
        case 4:
          ...
          message.eventIndex = longToNumber6(reader.uint64());
          continue;
        case 5:
          if (tag != 40) {
            break;
          }
          message.blockTimestamp = longToNumber6(reader.uint64());
          continue;
        case 6:
          if (tag != 50) {
            break;
  ...
  fromJSON(object) {
    return {
      seqnum: isSet7(object.seqnum) ? Number(object.seqnum) : 0,
      type: isSet7(object.type) ? blockEventTypeFromJSON(object.type) : 0,
      blockNumber: isSet7(object.blockNumber) ? Number(object.blockNumber) : 0,
      eventIndex: isSet7(object.eventIndex) ? Number(object.eventIndex) : 0,
      blockTimestamp: isSet7(object.blockTimestamp) ? Number(object.blockTimestamp) : 0,
      heartbeatEventBody: isSet7(object.heartbeatEventBody) ? HeartbeatEventBody.fromJSON(object.heartbeatEventBody) : void 0,
      mergeMessageEventBody: isSet7(object.mergeMessageEventBody) ? MergeMessageEventBody.fromJSON(object.mergeMessageEventBody) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
    message.seqnum !== void 0 && (obj.seqnum = Math.round(message.seqnum));
    message.type !== void 0 && (obj.type = blockEventTypeToJSON(message.type));
    message.blockNumber !== void 0 && (obj.blockNumber = Math.round(message.blockNumber));
    message.eventIndex !== void 0 && (obj.eventIndex = Math.round(message.eventIndex));
    message.blockTimestamp !== void 0 && (obj.blockTimestamp = Math.round(message.blockTimestamp));
    message.heartbeatEventBody !== void 0 && (obj.heartbeatEventBody = message.heartbeatEventBody ? HeartbeatEventBody.toJSON(message.heartbeatEventBody) : void 0);
    message.mergeMessageEventBody !== void 0 && (obj.mergeMessageEventBody = message.mergeMessageEventBody ? MergeMessageEventBody.toJSON(message.mergeMessageEventBody) : void 0);
    return obj;
  },
  create(base) {
    return BlockEventData.fromPartial(base != null ? base : {});
  },
  fromPartial(object) {
    var _a, _b, _c, _d, _e;
    const message = createBaseBlockEventData();
    message.seqnum = (_a = object.seqnum) != null ? _a : 0;
    message.type = (_b = object.type) != null ? _b : 0;
    message.blockNumber = (_c = object.blockNumber) != null ? _c : 0;
    message.eventIndex = (_d = object.eventIndex) != null ? _d : 0;
    message.blockTimestamp = (_e = object.blockTimestamp) != null ? _e : 0;
    message.heartbeatEventBody = object.heartbeatEventBody !== void 0 && object.heartbeatEventBody !== null ? HeartbeatEventBody.fromPartial(object.heartbeatEventBody) : void 0;
    message.mergeMessageEventBody = object.mergeMessageEventBody !== void 0 && object.mergeMessageEventBody !== null ? MergeMessageEventBody.fromPartial(object.mergeMessageEventBody) : void 0;
    return message;
  }
};
function createBaseBlockEvent() {
  return { hash: new Uint8Array(), data: void 0 };
}
var BlockEvent = {
  encode(message, writer = import_minimal7.default.Writer.create()) {
    if (message.hash.length !== 0) {
  ...
  fromJSON(object) {
    return {
      hash: isSet7(object.hash) ? bytesFromBase646(object.hash) : new Uint8Array(),
      data: isSet7(object.data) ? BlockEventData.fromJSON(object.data) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
    message.hash !== void 0 && (obj.hash = base64FromBytes6(message.hash !== void 0 ? message.hash : new Uint8Array()));
    message.data !== void 0 && (obj.data = message.data ? BlockEventData.toJSON(message.data) : void 0);
    return obj;
  },
  create(base) {
    return BlockEvent.fromPartial(base != null ? base : {});
  },
  fromPartial(object) {
    var _a;
    const message = createBaseBlockEvent();
    message.hash = (_a = object.hash) != null ? _a : new Uint8Array();
    message.data = object.data !== void 0 && object.data !== null ? BlockEventData.fromPartial(object.data) : void 0;
    return message;
  }
};
...
var ShardHeader = {
  ...
  fromJSON(object) {
    return {
      height: isSet7(object.height) ? Height.fromJSON(object.height) : void 0,
      timestamp: isSet7(object.timestamp) ? Number(object.timestamp) : 0,
      parentHash: isSet7(object.parentHash) ? bytesFromBase646(object.parentHash) : new Uint8Array(),
      shardRoot: isSet7(object.shardRoot) ? bytesFromBase646(object.shardRoot) : new Uint8Array()
    };
  },
  toJSON(message) {
    const obj = {};
    message.height !== void 0 && (obj.height = message.height ? Height.toJSON(message.height) : void 0);
    message.timestamp !== void 0 && (obj.timestamp = Math.round(message.timestamp));
    message.parentHash !== void 0 && (obj.parentHash = base64FromBytes6(message.parentHash !== void 0 ? message.parentHash : new Uint8Array()));
    message.shardRoot !== void 0 && (obj.shardRoot = base64FromBytes6(message.shardRoot !== void 0 ? message.shardRoot : new Uint8Array()));
    return obj;
  },
  create(base) {
...
var ShardChunk = {
  ...
  fromJSON(object) {
    return {
      header: isSet7(object.header) ? ShardHeader.fromJSON(object.header) : void 0,
      hash: isSet7(object.hash) ? bytesFromBase646(object.hash) : new Uint8Array(),
      transactions: Array.isArray(object == null ? void 0 : object.transactions) ? object.transactions.map((e) => Transaction.fromJSON(e)) : [],
      commits: isSet7(object.commits) ? Commits.fromJSON(object.commits) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var Transaction = {
  ...
  fromJSON(object) {
    return {
      ...
      accountRoot: isSet7(object.accountRoot) ? bytesFromBase646(object.accountRoot) : new Uint8Array()
    };
  },
  toJSON(message) {
    const obj = {};
    ...
    message.accountRoot !== void 0 && (obj.accountRoot = base64FromBytes6(message.accountRoot !== void 0 ? message.accountRoot : new Uint8Array()));
    return obj;
  },
  create(base) {
...
var FnameTransfer = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.fromFid = longToNumber6(reader.uint64());
          continue;
        case 4:
          if (tag != 34) {
            break;
  ...
  fromJSON(object) {
    return {
      ...
      fromFid: isSet7(object.fromFid) ? Number(object.fromFid) : 0,
      proof: isSet7(object.proof) ? UserNameProof.fromJSON(object.proof) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
function createBaseValidatorMessage() {
  return { onChainEvent: void 0, fnameTransfer: void 0, blockEvent: void 0 };
}
var ValidatorMessage = {
  ...
  fromJSON(object) {
    return {
      onChainEvent: isSet7(object.onChainEvent) ? OnChainEvent.fromJSON(object.onChainEvent) : void 0,
      fnameTransfer: isSet7(object.fnameTransfer) ? FnameTransfer.fromJSON(object.fnameTransfer) : void 0,
      blockEvent: isSet7(object.blockEvent) ? BlockEvent.fromJSON(object.blockEvent) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
    ...
    message.blockEvent !== void 0 && (obj.blockEvent = message.blockEvent ? BlockEvent.toJSON(message.blockEvent) : void 0);
    return obj;
  },
  create(base) {
  ...
  fromPartial(object) {
    ...
    message.blockEvent = object.blockEvent !== void 0 && object.blockEvent !== null ? BlockEvent.fromPartial(object.blockEvent) : void 0;
    return message;
  }
};
...
var StoreType = /* @__PURE__ */ ((StoreType2) => {
  ...
  StoreType2[StoreType2["STORAGE_LENDS"] = 7] = "STORAGE_LENDS";
  return StoreType2;
})(StoreType || {});
function storeTypeFromJSON(object) {
  switch (object) {
    ...
    case "STORE_TYPE_STORAGE_LENDS":
      return 7 /* STORAGE_LENDS */;
    default:
      throw new tsProtoGlobalThis8.Error("Unrecognized enum value " + object + " for enum StoreType");
  }
}
...
var BlocksRequest = {
  ...
  fromJSON(object) {
    return {
      shardId: isSet8(object.shardId) ? Number(object.shardId) : 0,
      startBlockNumber: isSet8(object.startBlockNumber) ? Number(object.startBlockNumber) : 0,
      stopBlockNumber: isSet8(object.stopBlockNumber) ? Number(object.stopBlockNumber) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var SubscribeRequest = {
  ...
  fromJSON(object) {
    return {
      ...
      fromId: isSet8(object.fromId) ? Number(object.fromId) : void 0,
      shardIndex: isSet8(object.shardIndex) ? Number(object.shardIndex) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var DbStats = {
  ...
  fromJSON(object) {
    return {
      numMessages: isSet8(object.numMessages) ? Number(object.numMessages) : 0,
      numFidRegistrations: isSet8(object.numFidRegistrations) ? Number(object.numFidRegistrations) : 0,
      approxSize: isSet8(object.approxSize) ? Number(object.approxSize) : 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var ShardInfo = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          message.numOnchainEvents = longToNumber7(reader.uint64());
          continue;
      }
      if ((tag & 7) == 4 || tag == 0) {
        break;
  ...
  fromJSON(object) {
    return {
      shardId: isSet8(object.shardId) ? Number(object.shardId) : 0,
      maxHeight: isSet8(object.maxHeight) ? Number(object.maxHeight) : 0,
      numMessages: isSet8(object.numMessages) ? Number(object.numMessages) : 0,
      numFidRegistrations: isSet8(object.numFidRegistrations) ? Number(object.numFidRegistrations) : 0,
      approxSize: isSet8(object.approxSize) ? Number(object.approxSize) : 0,
      blockDelay: isSet8(object.blockDelay) ? Number(object.blockDelay) : 0,
      mempoolSize: isSet8(object.mempoolSize) ? Number(object.mempoolSize) : 0,
      numOnchainEvents: isSet8(object.numOnchainEvents) ? Number(object.numOnchainEvents) : 0
    };
  },
  toJSON(message) {
    const obj = {};
...
function createBaseGetInfoResponse() {
  return { version: "", dbStats: void 0, peerId: "", numShards: 0, shardInfos: [], nextEngineVersionTimestamp: 0 };
}
var GetInfoResponse = {
  encode(message, writer = import_minimal8.default.Writer.create()) {
    if (message.version !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10:
          ...
          message.nextEngineVersionTimestamp = longToNumber7(reader.uint64());
          continue;
      }
      if ((tag & 7) == 4 || tag == 0) {
        break;
  ...
  fromJSON(object) {
    return {
      version: isSet8(object.version) ? String(object.version) : "",
      dbStats: isSet8(object.dbStats) ? DbStats.fromJSON(object.dbStats) : void 0,
      peerId: isSet8(object.peerId) ? String(object.peerId) : "",
      numShards: isSet8(object.numShards) ? Number(object.numShards) : 0,
      shardInfos: Array.isArray(object == null ? void 0 : object.shardInfos) ? object.shardInfos.map((e) => ShardInfo.fromJSON(e)) : [],
      nextEngineVersionTimestamp: isSet8(object.nextEngineVersionTimestamp) ? Number(object.nextEngineVersionTimestamp) : 0
    };
  },
  toJSON(message) {
    const obj = {};
    ...
    message.nextEngineVersionTimestamp !== void 0 && (obj.nextEngineVersionTimestamp = Math.round(message.nextEngineVersionTimestamp));
    return obj;
  },
  create(base) {
  ...
  fromPartial(object) {
    ...
    message.nextEngineVersionTimestamp = (_e = object.nextEngineVersionTimestamp) != null ? _e : 0;
    return message;
  }
};
...
var EventRequest = {
  ...
  fromJSON(object) {
    return {
      id: isSet8(object.id) ? Number(object.id) : 0,
      shardIndex: isSet8(object.shardIndex) ? Number(object.shardIndex) : 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var FidRequest = {
  ...
  fromJSON(object) {
    return {
      ...
      pageSize: isSet8(object.pageSize) ? Number(object.pageSize) : void 0,
      pageToken: isSet8(object.pageToken) ? bytesFromBase647(object.pageToken) : void 0,
      reverse: isSet8(object.reverse) ? Boolean(object.reverse) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var FidTimestampRequest = {
  ...
  fromJSON(object) {
    return {
      ...
      pageToken: isSet8(object.pageToken) ? bytesFromBase647(object.pageToken) : void 0,
      reverse: isSet8(object.reverse) ? Boolean(object.reverse) : void 0,
      startTimestamp: isSet8(object.startTimestamp) ? Number(object.startTimestamp) : void 0,
      stopTimestamp: isSet8(object.stopTimestamp) ? Number(object.stopTimestamp) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var FidsResponse = {
  ...
  fromJSON(object) {
    return {
      ...
      nextPageToken: isSet8(object.nextPageToken) ? bytesFromBase647(object.nextPageToken) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var CastsByParentRequest = {
  ...
  fromJSON(object) {
    return {
      parentCastId: isSet8(object.parentCastId) ? CastId.fromJSON(object.parentCastId) : void 0,
      parentUrl: isSet8(object.parentUrl) ? String(object.parentUrl) : void 0,
      pageSize: isSet8(object.pageSize) ? Number(object.pageSize) : void 0,
      pageToken: isSet8(object.pageToken) ? bytesFromBase647(object.pageToken) : void 0,
      reverse: isSet8(object.reverse) ? Boolean(object.reverse) : void 0
    };
...
var ReactionRequest = {
  ...
  fromJSON(object) {
    return {
      fid: isSet8(object.fid) ? Number(object.fid) : 0,
      reactionType: isSet8(object.reactionType) ? reactionTypeFromJSON(object.reactionType) : 0,
      targetCastId: isSet8(object.targetCastId) ? CastId.fromJSON(object.targetCastId) : void 0,
      targetUrl: isSet8(object.targetUrl) ? String(object.targetUrl) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var ReactionsByFidRequest = {
  ...
  fromJSON(object) {
    return {
      fid: isSet8(object.fid) ? Number(object.fid) : 0,
      reactionType: isSet8(object.reactionType) ? reactionTypeFromJSON(object.reactionType) : void 0,
      pageSize: isSet8(object.pageSize) ? Number(object.pageSize) : void 0,
      pageToken: isSet8(object.pageToken) ? bytesFromBase647(object.pageToken) : void 0,
      reverse: isSet8(object.reverse) ? Boolean(object.reverse) : void 0
    };
...
var UserDataRequest = {
  ...
  fromJSON(object) {
    return {
      fid: isSet8(object.fid) ? Number(object.fid) : 0,
      userDataType: isSet8(object.userDataType) ? userDataTypeFromJSON(object.userDataType) : 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var OnChainEventRequest = {
  ...
  fromJSON(object) {
    return {
      fid: isSet8(object.fid) ? Number(object.fid) : 0,
      eventType: isSet8(object.eventType) ? onChainEventTypeFromJSON(object.eventType) : 0,
      pageSize: isSet8(object.pageSize) ? Number(object.pageSize) : void 0,
      pageToken: isSet8(object.pageToken) ? bytesFromBase647(object.pageToken) : void 0,
      reverse: isSet8(object.reverse) ? Boolean(object.reverse) : void 0
    };
...
var TierDetails = {
  ...
  fromJSON(object) {
    return {
      tierType: isSet8(object.tierType) ? tierTypeFromJSON(object.tierType) : 0,
      expiresAt: isSet8(object.expiresAt) ? Number(object.expiresAt) : 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var StorageLimitsResponse = {
  ...
  fromJSON(object) {
    return {
      ...
      units: isSet8(object.units) ? Number(object.units) : 0,
...
var StorageUnitDetails = {
  ...
  fromJSON(object) {
    return {
      unitType: isSet8(object.unitType) ? storageUnitTypeFromJSON(object.unitType) : 0,
      unitSize: isSet8(object.unitSize) ? Number(object.unitSize) : 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var StorageLimit = {
  ...
  fromJSON(object) {
    return {
      storeType: isSet8(object.storeType) ? storeTypeFromJSON(object.storeType) : 0,
      name: isSet8(object.name) ? String(object.name) : "",
      limit: isSet8(object.limit) ? Number(object.limit) : 0,
      used: isSet8(object.used) ? Number(object.used) : 0,
      earliestTimestamp: isSet8(object.earliestTimestamp) ? Number(object.earliestTimestamp) : 0,
      earliestHash: isSet8(object.earliestHash) ? bytesFromBase647(object.earliestHash) : new Uint8Array()
    };
  },
  toJSON(message) {
    const obj = {};
...
var UsernameProofRequest = {
  ...
  fromJSON(object) {
    return { name: isSet8(object.name) ? bytesFromBase647(object.name) : new Uint8Array() };
  },
  toJSON(message) {
    const obj = {};
...
var ValidationResponse = {
  ...
  fromJSON(object) {
    return {
      valid: isSet8(object.valid) ? Boolean(object.valid) : false,
      message: isSet8(object.message) ? Message.fromJSON(object.message) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var VerificationRequest = {
  ...
  fromJSON(object) {
    return {
      fid: isSet8(object.fid) ? Number(object.fid) : 0,
      address: isSet8(object.address) ? bytesFromBase647(object.address) : new Uint8Array()
    };
  },
  toJSON(message) {
    const obj = {};
...
var LinkRequest = {
  ...
  fromJSON(object) {
    return {
      fid: isSet8(object.fid) ? Number(object.fid) : 0,
      linkType: isSet8(object.linkType) ? String(object.linkType) : "",
      targetFid: isSet8(object.targetFid) ? Number(object.targetFid) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var LinksByFidRequest = {
  ...
  fromJSON(object) {
    return {
      fid: isSet8(object.fid) ? Number(object.fid) : 0,
      linkType: isSet8(object.linkType) ? String(object.linkType) : void 0,
      pageSize: isSet8(object.pageSize) ? Number(object.pageSize) : void 0,
      pageToken: isSet8(object.pageToken) ? bytesFromBase647(object.pageToken) : void 0,
      reverse: isSet8(object.reverse) ? Boolean(object.reverse) : void 0
    };
...
var IdRegistryEventByAddressRequest = {
  ...
  fromJSON(object) {
    return { address: isSet8(object.address) ? bytesFromBase647(object.address) : new Uint8Array() };
  },
  toJSON(message) {
    const obj = {};
    message.address !== void 0 && (obj.address = base64FromBytes7(message.address !== void 0 ? message.address : new Uint8Array()));
...
var MessageError = {
  ...
  fromJSON(object) {
    return {
      hash: isSet8(object.hash) ? bytesFromBase647(object.hash) : new Uint8Array(),
      errCode: isSet8(object.errCode) ? String(object.errCode) : "",
      message: isSet8(object.message) ? String(object.message) : ""
    };
  },
  toJSON(message) {
    const obj = {};
...
var BulkMessageResponse = {
  ...
  fromJSON(object) {
    return {
      message: isSet8(object.message) ? Message.fromJSON(object.message) : void 0,
      messageError: isSet8(object.messageError) ? MessageError.fromJSON(object.messageError) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var TrieNodeMetadataRequest = {
  ...
  fromJSON(object) {
    return {
      shardId: isSet8(object.shardId) ? Number(object.shardId) : 0,
      prefix: isSet8(object.prefix) ? bytesFromBase647(object.prefix) : new Uint8Array()
    };
  },
  toJSON(message) {
    const obj = {};
...
var TrieNodeMetadataResponse = {
  ...
  fromJSON(object) {
    return {
      prefix: isSet8(object.prefix) ? bytesFromBase647(object.prefix) : new Uint8Array(),
      numMessages: isSet8(object.numMessages) ? Number(object.numMessages) : 0,
      hash: isSet8(object.hash) ? String(object.hash) : "",
...
var EventsRequest = {
  ...
  fromJSON(object) {
    return {
      startId: isSet8(object.startId) ? Number(object.startId) : 0,
      shardIndex: isSet8(object.shardIndex) ? Number(object.shardIndex) : void 0,
      stopId: isSet8(object.stopId) ? Number(object.stopId) : void 0,
      pageSize: isSet8(object.pageSize) ? Number(object.pageSize) : void 0,
      pageToken: isSet8(object.pageToken) ? bytesFromBase647(object.pageToken) : void 0,
      reverse: isSet8(object.reverse) ? Boolean(object.reverse) : void 0
    };
...
var FidAddressTypeResponse = {
  ...
  fromJSON(object) {
    return {
      isCustody: isSet8(object.isCustody) ? Boolean(object.isCustody) : false,
      isAuth: isSet8(object.isAuth) ? Boolean(object.isAuth) : false,
      isVerified: isSet8(object.isVerified) ? Boolean(object.isVerified) : false
    };
  },
  toJSON(message) {
    const obj = {};
...
var ContactInfoBody = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.timestamp = longToNumber7(reader.uint64());
          continue;
        case 6:
          if (tag != 50) {
            break;
  ...
  fromJSON(object) {
    return {
      gossipAddress: isSet8(object.gossipAddress) ? String(object.gossipAddress) : "",
      peerId: isSet8(object.peerId) ? bytesFromBase647(object.peerId) : new Uint8Array(),
      snapchainVersion: isSet8(object.snapchainVersion) ? String(object.snapchainVersion) : "",
      network: isSet8(object.network) ? farcasterNetworkFromJSON(object.network) : 0,
      timestamp: isSet8(object.timestamp) ? Number(object.timestamp) : 0,
      announceRpcAddress: isSet8(object.announceRpcAddress) ? String(object.announceRpcAddress) : ""
    };
  },
  toJSON(message) {
    const obj = {};
    message.gossipAddress !== void 0 && (obj.gossipAddress = message.gossipAddress);
    message.peerId !== void 0 && (obj.peerId = base64FromBytes7(message.peerId !== void 0 ? message.peerId : new Uint8Array()));
    message.snapchainVersion !== void 0 && (obj.snapchainVersion = message.snapchainVersion);
    message.network !== void 0 && (obj.network = farcasterNetworkToJSON(message.network));
    message.timestamp !== void 0 && (obj.timestamp = Math.round(message.timestamp));
    message.announceRpcAddress !== void 0 && (obj.announceRpcAddress = message.announceRpcAddress);
    return obj;
  },
  create(base) {
  ...
  fromPartial(object) {
    ...
    message.network = (_d = object.network) != null ? _d : 0;
    message.timestamp = (_e = object.timestamp) != null ? _e : 0;
    message.announceRpcAddress = (_f = object.announceRpcAddress) != null ? _f : "";
    return message;
  }
};
...
if (import_minimal8.default.util.Long !== import_long7.default) {
  import_minimal8.default.util.Long = import_long7.default;
...
__export(validations_exports, {
  ...
  validateLendStorageBody: () => validateLendStorageBody,
  ...
  validateProfileToken: () => validateProfileToken,
...
var validateMessageData = async (data, publicClients = defaultPublicClients) => {
  ...
  } else if (validType.value === 15 /* LEND_STORAGE */ && !!data.lendStorageBody) {
    if (data.timestamp < farcasterTime.value - 60 * 10) {
      bodyResult = err4(new HubError("bad_request.validation_failure", "timestamp more than 10 mins in the past"));
    } else {
...
var validateCastAddBody = (body, allowEmbedsDeprecated = false) => {
  ...
  if (body.type === 2 /* TEN_K_CAST */ && textBytes.length > 1e4) {
    return err4(new HubError("bad_request.validation_failure", "text > 10,000 bytes for 10k cast"));
  }
  if (body.type === 2 /* TEN_K_CAST */ && textBytes.length <= 1024) {
    return err4(new HubError("bad_request.validation_failure", "text too short for 10k cast"));
  }
  ...
  if (body.embeds.length > 4) {
    return err4(new HubError("bad_request.validation_failure", "embeds > 4"));
  }
...
var validateLendStorageBody = (body) => {
  if (body.numUnits > 5e3) {
    return err4(new HubError("bad_request.validation_failure", "num storage units too large"));
  }
  return ok4(body);
};
  ...
  switch (type) {
    ...
    case 11 /* USER_DATA_PRIMARY_ADDRESS_ETHEREUM */: {
      if (valueBytes.length > 42) {
        return err4(new HubError("bad_request.validation_failure", "invalid length for eth address"));
      }
      break;
    }
    case 12 /* USER_DATA_PRIMARY_ADDRESS_SOLANA */: {
      if (valueBytes.length > 44) {
        return err4(new HubError("bad_request.validation_failure", "invalid length for sol address"));
      }
      break;
    }
    case 10 /* BANNER */: {
      if (valueBytes.length > 256) {
        return err4(new HubError("bad_request.validation_failure", "banner value > 256"));
      }
      break;
    }
    case 13 /* PROFILE_TOKEN */: {
      if (value !== "") {
        if (valueBytes.length > 256) {
          return err4(new HubError("bad_request.validation_failure", "profile token value > 256"));
        }
        const validatedProfileToken = validateProfileToken(value);
        if (validatedProfileToken.isErr()) {
          return err4(validatedProfileToken.error);
        }
      }
      break;
    }
...
var validateProfileToken = (token) => {
  const caip19Regex = new RegExp("^[a-z0-9]+:[a-zA-Z0-9]+/[a-z0-9-]{3,8}:[-.%a-zA-Z0-9]{1,128}(/[a-zA-Z0-9]+)?$");
  if (!caip19Regex.test(token)) {
    return err4(new HubError("bad_request.validation_failure", "profile token is not a valid CAIP-19 token"));
  }
  return ok4(token);
};
...
var makeLendStorageData = async (body, dataOptions) => {
  return makeMessageData({ lendStorageBody: body }, 15 /* LEND_STORAGE */, dataOptions);
};
var makeLendStorage = async (body, dataOptions, signer) => {
